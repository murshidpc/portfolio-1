...
const Landing = ({ setSelectedPage }) => {
  ...
  return (
    <section
      id="home"
      className="md:flex md:justify-between md:items-center md:h-full overflow:hidden gap-16 py-10"
    >
      {/* IMAGE SECTION*/}
      ...
      {/* MAIN SECTION */}
      <div className="basis-2/5 z-30 mt-16 md:mt-32">
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          >
            <div
              className="bg-deep-blue hover:text-red transition duration-500 w-full h-full
                 flex justify-center items-center px-10 font-playfair"
            >
              Lets Talk
            </div>
          </AnchorLink>
